<?php 
    ...
    if (isset($_GET['delete'])) {
        ...
        echo $delete_id;
        $deletestmt = $db->query("DELETE FROM `fg_data` WHERE `fg_id` = '$delete_id'");
        $deletestmt->execute();
...
<head>
    ...
    <title>บันทึกข้อมูลแพะขุน</title>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">เพิ่มข้อมูลแพะขุน</h5>
                ...
                <div class="modal-body">
                    <form action="Check_add_fg.php" method="POST">
                        ...
                        <div class="mb-3">
                            <label for="firstname" class="col-form-label">สายพันธ์ุ</label>
                ...
                <div class="container-fluid">
                    <div class="card shadow mb-4">
                        <div class="card-header py-3 text-center">
                            <h3 class="m-0 font-weight-bold text-primary">ข้อมูลแพะขุน</h3>
                        </div>
                        <div class="row mt-4 ml-2">
                            <div class="col">
                                <a class="btn btn-blue" style="border-radius: 30px;" type="submit" data-toggle="modal" data-target="#AddFooodModal">เพิ่มข้อมูลแพะขุน</a>
                            </div>
                        </div>
                        <div class="card-body">
