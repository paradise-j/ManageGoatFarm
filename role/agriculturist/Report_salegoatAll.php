...
<head>
    ...
    <title>สรุปยอดขายแพะในฟาร์ม</title>
                        ...
                        <div class="col-lg-12">
                            <div class="card shadow mb-4">
                                <div class="card-header py-3 text-center">
                                    <h2 class="m-0 font-weight-bold text-primary">สรุปยอดขายแพะทั้งหมดในฟาร์ม</h2>
                                </div>
                                <div class="card-body">
                                    ...
                                    <?php 
                                        ...
                                        if(isset($_POST["submit"])){
                                            ...
                                            $stmt2 = $db->query("SELECT SUM(salelist.slist_price) as total , MONTH(sale_date) as month 
                                                                ...
                                                                WHERE (user_login.user_id = '$id') AND MONTH(sale_date) BETWEEN MONTH('$start_date') AND MONTH('$end_date')
